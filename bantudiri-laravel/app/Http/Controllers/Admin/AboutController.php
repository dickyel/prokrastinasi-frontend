...
class AboutController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $query = About::query()->orderByDesc('created_at');
                        ...
                        <div class="btn-group">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="action' .  $item->id . '">
                                    <a class="dropdown-item" href="' . route('about-admin.edit', $item->id) . '">
                                        Edit
                                    </a>
                                    <form action="' . route('about-admin.destroy', $item->id) . '" method="POST">
